...
class App(ctk.CTk, tk.Tk):
    def __init__(self, width, height): enter
    self.width = height
    self.height = height
    self.padx = 10
    self.pady = 5
    ...
    self.frame_right.grid(
            column=1, row=1, padx=self.padx, pady=5, sticky='n')
    self.frame_upper_right.grid(
            column=0, row=0, padx=self.padx, pady=5, sticky='nsew')
    self.frame_bottom_right.grid(
            column=0, row=1, padx=self.padx, pady=5, sticky='n')
    # create CTk scrollbar
    # self.scrollbar = ctk.CTkScrollbar(self.frame_bottom_right)
    # self.scrollbar.grid(row=0, column=1, sticky="ns")

    self.button_refresh.grid(
            column=0, row=0, padx=1 * self.padx, pady=10, sticky='w')
    self.button_clear_one.grid(
            column=1, row=0, padx=1 * self.padx, pady=10)
    self.button_clear.grid(column=2, row=0, padx=1
                           * self.padx, pady=10, sticky='e')
