...
class App(ctk.CTk, tk.Tk):
    ...
    def refresh(self):
        ...
        self.radio_button_frame_1 = RBF.RadioButtonFrame(self.frame_bottom_right, frame_height=self.frame_bottom_right["height"],ip_list=[])
        self.radio_button_frame_1.grid(row=0, column=0, sticky="nw")
        self.radio_button_frame_1 = RBF.RadioButtonFrame(self.frame_bottom_right, frame_height=self.frame_bottom_right["height"],ip_list=IP_list)
        self.radio_button_frame_1.grid(row=0, column=0, sticky="nw")
    ...
    def clear_one(self):
        selected_value = self.radio_button_frame_1.get_value()
