...
class App(ctk.CTk, tk.Tk):
    def __init__(self, width, height):
        ...
        self.ip_list_frame.grid(column=0, row=2, padx=self.padx, pady=self.pady, sticky="n")
        self.new_rule_frame.grid(column=0, row=3, padx=self.padx, pady=self.pady, sticky="s")
