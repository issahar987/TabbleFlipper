...
class App(ctk.CTk, tk.Tk):
    def __init__(self, width, height):
        ...
        self.chain_frame.grid(column=0, row=0, padx=self.padx, pady=0, sticky="n")
        ...
        self.functions_frame.grid(column=0, row=1, padx=self.padx, pady=0, sticky="n")

        self.ip_list_frame = ip_list_frame.IpListFrame(master=self,
                                                  width=self.width,
                                                  height=(65 * self.height) / 100,
                                                  button_width=self.button_width)

        self.ip_list_frame.grid(column=0, row=3, padx=self.padx, pady=self.pady, sticky="n")
        ...
        self.new_rule_frame.grid(column=0, row=4, padx=self.padx, pady=self.pady, sticky="n")
